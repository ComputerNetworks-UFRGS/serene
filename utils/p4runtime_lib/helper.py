...
class P4InfoHelper(object):
    ...
    def buildCloneSessionEntry(self, clone_session_id, replicas, packet_length_bytes=0):
        ...
        # clone_entry.session_id = clone_session_id
        # clone_entry.packet_length_bytes = packet_length_bytes
        # clone_entry.class_of_service = 0  # PI currently supports only CoS=0 for clone session entry
        ...
        for replica in replicas:
            ...
            # clone_entry.replicas.extend([r])
        print(type(clone_entry.clone_session_entry), clone_entry)
        return clone_entry
